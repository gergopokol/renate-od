...
class JanevData:
    ...
    def get_cross_section(self, transition, energy_grid):
        ...
        eloss = {'p': self.__eloss_p,
                 'e': self.__ion_e}
        trans_type = {'ex': excitations,
                      'ion': ionizations,
                      'cx': charge_ex,
                      'eloss': eloss}
        if trans['target'] in trans_type[trans['name']]:
            cross_function = trans_type[trans['name']][trans['target']]
        else:
            cross_function = trans_type[trans['name']]['Z']
...
###################################################################################################################
    ...
    def __ex_e(self, trans, energy_grid):
        ...
        if n == 1 and m > 5:  # Corrected according to Johnson.
            y = 1-(1/m)**2
    ...
    def __ex_He(self, trans, energy_grid):
        n = int(trans['from_level'])
        m = int(trans['to_level'])
    ...
    def __ex_Be(self, trans, energy_grid):
        n = int(trans['from_level'])
        m = int(trans['to_level'])
        e = energy_grid/1e3/trans['target_mass']
    ...
    def __ex_Z(self, trans, energy_grid):
        n = int(trans['from_level'])
        m = int(trans['to_level'])
    ...
    def __ion_e(self, trans, energy_grid):
        n = int(trans['from_level'])
        ...
        if n > 3:  # Corrected according to Johnson.
            y = 1-(1/n)**2
            b = 1/n*(4.0-18.63/n+36.24/n**2-28.09/n**3)
            A = self.__get_A(n)
            eq = '14'
    ...
    def __ion_He(self, trans, energy_grid):
        n = int(trans['from_level'])
        e = energy_grid/1e3/trans['target_mass']
    ...
    def __ion_Be(self, trans, energy_grid):
        n = int(trans['from_level'])
        e = energy_grid/1e3/trans['target_mass']
    ...
    def __cx_He(self, trans, energy_grid):
        n = int(trans['from_level'])
        e = energy_grid/1e3/trans['target_mass']
    ...
    def __eloss_p(self, trans, energy_grid):
        sigma_ion = self.__ion_p(trans, energy_grid)
        sigma_cx = self.__cx_p(trans, energy_grid)
