...
class Rates:
    ...
    def setup_rate_coeff_arrays(self):
        ...
        electron_neutral_collisions_array = self.get_data_from_hdf5(filename,
                                                               'Collisional Coeffs/Electron Neutral Collisions') / 1e4  # changing of units
        proton_neutral_collisions_array = self.get_data_from_hdf5(filename,
                                                             'Collisional Coeffs/Proton Neutral Collisions') / 1e4
        impurity_neutral_collisions_array = self.get_data_from_hdf5(filename,
                                                               'Collisional Coeffs/Impurity Neutral Collisions') / 1e4
        electron_loss_collisions_array = self.get_data_from_hdf5(filename,
                                                            'Collisional Coeffs/Electron Loss Collisions') / 1e4
